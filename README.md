...
- Built a full-stack AI codebase onboarding agent with FastAPI, React, TypeScript, OpenAI, and Chroma.
- Implemented public GitHub repository ingestion, file filtering, deterministic code chunking, embeddings, and local vector retrieval.
- Designed source-linked answer generation with GitHub permalinks to commit-pinned file and line citations.
- Added a demo-ready frontend for repo indexing, question answering, answer history, and citation inspection.
- Wrote backend tests for URL validation, ingestion filtering, chunking, citation metadata, vector indexing, and QA orchestration without real OpenAI calls.
